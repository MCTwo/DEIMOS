...
def optimalPA(H,delta,phi):
    '''
    This is based on:
    Filippenko A.V., 1982. The importance of atmospheric differential refraction
    in spectrophotometry. Publication of the Astronomical Soecity of the
    Pacific, 94, pp.715-721
    Available at :http://adsabs.harvard.edu/abs/1982PASP...94...715F
    Input:
    phi = [float; units = degrees] observer latitude 
    H = [float; units= hours]objects' hour angle(H is + if west of the meridian)
