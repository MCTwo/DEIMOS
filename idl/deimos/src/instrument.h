define		NPARAM	44		# no of param (last + 24)
...
define		XFO_TLT	$1[19]		# Tilt of focal plane in X (rad)
define		YFO_TLT	$1[20]		# Tilt of focal plane in Y (rad)

define		CN_XERR	$1[18+$2*3]	# x-adjustment in pixels
define		CN_YERR	$1[19+$2*3]	# y-adjustment in pixels
define		CN_RERR	$1[20+$2*3]	# rotation error
