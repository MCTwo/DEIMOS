...
;   MD 18nov02
;----------------------------------------------------------------------
pro template_m31_stars_create, fileout
...
;      stars_deep2 = fltarr(nspecpix, n_elements(whnames2))
      stars_deep2 = fltarr(nspecpix, n_elements(whnames))
...
; wavelength range.
         ...
         stars_deep2[0:naddlow-1,i]= $
           median(stars_deep[0:10,i])
         stars_deep2[noldspec+naddlow:nspecpix-1,i]= $
           median(stars_deep[noldspec-11:noldspec-1,i])
         stars_deep2[naddlow:noldspec+naddlow-1,i]=stars_deep[*,i]
      ...
      writefits, fileout2, stars_deep2, hdr
