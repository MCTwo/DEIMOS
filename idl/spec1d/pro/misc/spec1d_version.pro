...
;
; PURPOSE:
;   Return the version name for the product spec1d
;
; CALLING SEQUENCE:
;   vers = spec1d_version()
;
...
;
; OUTPUTS:
;   vers       - Version name for the product spec1d
;
; COMMENTS:
...
;   $SPEC1D_DIR.  For example, if you are using a version of the code
;   in the directory '/u/schlegel/spec1d/v0_0', then this returns
;   'CVS:v0_0'.
;
; BUGS:
;
