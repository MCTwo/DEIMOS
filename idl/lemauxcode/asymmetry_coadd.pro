;for calculating the asymmetry of a Lya emission line (or effective Lya line) in the manner of Dawson et al. 2004, modified for use with a single (coadded) spectrum
...
pro asymmetry_coadd, spec, width

	
        corrspec = mrdfits(spec,1)
	
	initlam = 1215.7			;can always fake this, the -2 is from airtovac
	...
	print, 'The asymmetry of spectrum', spec, 'is', asymmetry[0]
