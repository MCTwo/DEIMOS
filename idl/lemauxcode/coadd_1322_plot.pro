...
function Standardize_Spectra, $
    ...
    d_lambdat = (5300.-3650.)/12000. ; wavelength spacing in Angstroms of coadded spectrum
    lambdat = d_lambdat * dindgen(12000) + 3650. ; wavelength array of coadded spectrum
...
pro Perform_Coadd
    ...
    numread = 77              ; number of columns to read

    ; read in the specifications for each serendip
    readcol, '1322coadd.list',  format='A,A,A,D,A,D', mask, slit, obj, Iband, q, z, skipline=2, numline=numread
    file = '/' + mask + '/2006may31/spec1d.' + mask + '.' + slit + '.' + obj + '.fits'
    file = '/Volumes/Data2/orelse/lemaux/deimos/1322'      + file
    ...
    finalspec.spec = spec
    finalspec.ivar = ivar
    mwrfits, finalspec, '1322coadd.fits'
    device, retain=2
