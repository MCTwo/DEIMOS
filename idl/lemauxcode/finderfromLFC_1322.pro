pro finderfromLFC, setup, maketable, viewchart, makechart
	...
	hdr = headfits('/Volumes/Data2/orelse/lemaux/LFC/1322/sc1322_deep_trim.fits')
	...
	readcol, '/Volumes/Data2/orelse/lemaux/deimos/1322/cluster_catalog/NIRSPEC/starcats/setup' + setup + '/1322.NIRSPECtargetsEWcat.cat', format='D,D,A,A,D,D,D', RAtar, dectar, mask, slit, rbandtar, ibandtar, zbandtar	;get all target properties
	N = n_elements(RAtar)
	...
	readcol, '/Volumes/Data2/orelse/lemaux/deimos/1322/cluster_catalog/NIRSPEC/prioritycats/d_PA_allpriorities.1322.cat', format='A,A,D,D', compmask1, compmask2, tartard, tartarPA	;get all relative positions and PAs from potential target list
	...
	readcol, '/Volumes/Data2/orelse/lemaux/deimos/1322/cluster_catalog/NIRSPEC/spectroscopic.autocompile.blemaux.1322.kindaFINAL.zqgte3.clusteronly.cat', format='A,A,A', specID, specmask, specslit
	readcol, '/Volumes/Data2/orelse/lemaux/deimos/1322/cluster_catalog/NIRSPEC/sc1322.lfc.neat.IDswPAs.cat', format='A,D', refID, SEXPA
	...
	readcol, '/Volumes/Data2/orelse/lemaux/deimos/1322/cluster_catalog/NIRSPEC/starcats/setup' + setup + '/' + mask[i] + '.' + slit[i] + '.staroutput.cat', format = 'A,A,D,D,D,D,D', refslitindv, LFCIDindv, dgsindv, PAgsindv, rbandgsindv, ibandgsindv, zbandgsindv
	...
	readcol, '/Volumes/Data2/orelse/lemaux/deimos/1322/cluster_catalog/NIRSPEC/starcats/setup'+ setup + '/goodguidestars.cat', format='A', gsID 	;get LFC IDs of good guide stars from list
	readcol, '/Volumes/Data2/orelse/lemaux/deimos/1322/cluster_catalog/sc1322.lfc.radecmag.cat', format= 'A,D,D,D,D,D,A', LFCnewercatID, LFCRA, LFCdec, LFCr, LFCi, LFCz, LFCcatID 	;get RA/Dec of all LFC+COS objects from final LFC cat
	...
	file = '/Volumes/Data2/orelse/lemaux/deimos/1322/cluster_catalog/NIRSPEC/starcats/setup' + setup + '/cutout.setup' + setup + '.fits' ;read in the finder chart
	finder = mrdfits(file,0)

	if n_elements(finder) lt 10 then begin ;if finder chart doesn't exist then make one

        mm = mrdfits('/Volumes/Data2/orelse/lemaux/LFC/1322/sc1322_deep_trim.fits')
	...
	openw, lun, '/Volumes/Data2/orelse/lemaux/deimos/1322/cluster_catalog/NIRSPEC/starcats/setup' + setup + '/description.setup' + setup + '.cat', /get_lun
	...
	printf, lun, '13GS'+gsnum[i]+'NIR'+ setup, tab, goodgsID[i], tab, rank[i], tab, mask[0]+"."+slit[0], tab,  gsRAsexh[i], ':', gsRAsexm[i], ':', gsRAsexs[i], tab, gsdecsexdeg[i], ':', gsdecsexam[i], ':', gsdecsexas[i], tab, rbandgoodgs[i], tab, dgoodgs[i], tab, PAgoodgs[i], tab, dRAgoodgs[i], tab, ddecgoodgs[i], format='(a17, a1, a15, a1, i1, a1, a12, a1, i2.2, a1, i2.2, a1, d6.3, a1, i2.2, a1, i2.2, a1, d5.2, a1, d8.3, a1, d8.3, a1, d8.3, a1, d8.3, a1, d8.3)' 
	endfor

	if n_elements(PAgoodgs2) gt 1 then for i=0, 3-1 do begin
	printf, lun, '13GS'+gsnum[i]+'NIR'+ setup, tab, goodgsID[i], tab, rank[i], tab, mask[1]+"."+slit[1], tab, gsRAsexh[i], ':', gsRAsexm[i], ':', gsRAsexs[i], tab, gsdecsexdeg[i], ':', gsdecsexam[i], ':', gsdecsexas[i], tab, rbandgoodgs[i], tab, dgoodgs2[i], tab, PAgoodgs2[i], tab, dRAgoodgs2[i], tab, ddecgoodgs2[i], format='(a17, a1, a15, a1, i1, a1, a12, a1, i2.2, a1, i2.2, a1, d6.3, a1, i2.2, a1, i2.2, a1, d5.2, a1, d7.3, a1, d6.3, a1, d7.3, a1, d7.3, a1, d7.3)' 
	endfor	
	if n_elements(PAgoodgs3) gt 1 then for i=0, 3-1 do begin
        printf, lun, '13GS'+gsnum[i]+'NIR'+ setup, tab, goodgsID[i], tab, rank[i], tab, mask[2]+"."+slit[2], tab, gsRAsexh[i], ':', gsRAsexm[i], ':', gsRAsexs[i], tab, gsdecsexdeg[i], ':', gsdecsexam[i], ':', gsdecsexas[i], tab, rbandgoodgs[i], tab, dgoodgs3[i], tab, PAgoodgs3[i], tab, dRAgoodgs3[i], tab, ddecgoodgs3[i], format='(a17, a1, a15, a1, i1, a1, a12, a1, i2.2, a1, i2.2, a1, d6.3, a1, i2.2, a1, i2.2, a1, d5.2, a1, d7.3, a1, d6.3, a1, d7.3, a1, d7.3, a1, d7.3)' 
        endfor
	...
	printf, lun, gsnum[0] + '-' + gsnum[1], tab, '13GS'+gsnum[0]+'NIR'+ setup, tab, '13GS'+gsnum[1]+'NIR' + setup, tab, 3600*goodgsgsd[0], tab, 360/(2*!PI)*goodgsgsPA[0], tab, goodgsgsdRA[0], tab, goodgsgsddec[0], format='(a20, a1, a17, a1, a17, a1, d8.3, a1, d8.3, a1, d8.3, a1, d8.2)'	
	printf, lun, gsnum[0] + '-' + gsnum[2], tab, '13GS'+gsnum[0]+'NIR'+ setup, tab, '13GS'+gsnum[2]+'NIR'+ setup, tab, 3600*goodgsgsd[1], tab, 360/(2*!PI)*goodgsgsPA[1], tab, goodgsgsdRA[1], tab, goodgsgsddec[1], format='(a20, a1, a17, a1, a17, a1, d8.3, a1, d8.3, a1, d8.3, a1, d8.2)'
	printf, lun, gsnum[1] + '-' + gsnum[2], tab, '13GS'+gsnum[1]+'NIR'+ setup, tab, '13GS'+gsnum[2]+'NIR'+ setup, tab, 3600*goodgsgsd[2], tab, 360/(2*!PI)*goodgsgsPA[2], tab, goodgsgsdRA[2], tab, goodgsgsddec[2], format='(a20, a1, a17, a1, a17, a1, d8.3, a1, d8.3, a1, d8.3, a1, d8.2)'
	...
	entry_device = !d.name
	set_plot, 'PS'
	device, /color, bits_per_pixel=24, filename = '/Volumes/Data2/orelse/lemaux/deimos/1322/cluster_catalog/NIRSPEC/starcats/setup' + setup + '/setup'+ setup+ '.finder.ps', xoffset=0.75, yoffset= 0.75, xsize=7.75, ysize=10.25, /inches
	...
	windowXSize = !d.x_size		; get the x-window size in device coordinates of the PS window
   	...
   	tv, bytscl(finder, min=-3000., max=-2000.), x0, y0, XSIZE=xsize, YSIZE=ysize	
	...
	xyouts, (0.15/7.0)*windowXsize, 6500-500*[N-1+8], string(gsnum[0], format='(I1)') + '-' + string(gsnum[1], format='(I1)') + '       13GS'+ string(gsnum[0], format='(I1)') +'NIR'+ setup + '      13GS'+ string(gsnum[1], format='(I1)') +'NIR' + setup + '      ' +  string(goodgsgsdRA[0], format='(D7.3)') + '   ' +  string(goodgsgsddec[0], format='(D8.3)'), charsize=1, color=0, /device	
	xyouts, (0.15/7.0)*windowXsize, 6500-500*[N-1+9], string(gsnum[0], format='(I1)') + '-' + string(gsnum[2], format='(I1)') + '       13GS'+ string(gsnum[0], format='(I1)') +'NIR'+ setup + '      13GS'+ string(gsnum[2], format='(I1)') +'NIR' + setup + '      ' +  string(goodgsgsdRA[1], format='(D7.3)') + '   ' +  string(goodgsgsddec[1], format='(D7.3)'), charsize=1, color=0, /device
	xyouts, (0.15/7.0)*windowXsize, 6500-500*[N-1+10], string(gsnum[1], format='(I1)') + '-' + string(gsnum[2], format='(I1)') + '       13GS'+ string(gsnum[1], format='(I1)') +'NIR'+ setup + '      13GS'+ string(gsnum[2], format='(I1)') +'NIR' + setup + '      ' +  string(goodgsgsdRA[2], format='(D7.3)') + '   ' +  string(goodgsgsddec[2], format='(D7.3)'), charsize=1, color=0, /device
