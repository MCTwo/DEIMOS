pro finderfromLFC, setup, maketable, viewchart, makechart
	...
	readcol, '/Volumes/Data2/orelse/lemaux/deimos/sc1604/cluster_catalog/EWcats/newEWcats/NIRSPEC/starcats/setup' + setup + '/NIRSPECtargetsEWcat.cat', format='D,D,A,A,D,D,D', RAtar, dectar, mask, slit, rbandtar, ibandtar, zbandtar	;get all target properties
	...
	readcol, '/Volumes/Data2/orelse/lemaux/deimos/sc1604/cluster_catalog/EWcats/newEWcats/NIRSPEC/1stn2ndn3rdprioritydPA.cat', format='A,A,D,D', compmask1, compmask2, tartard, tartarPA	;get all relative positions and PAs from potential target list
	...
	readcol, '/Volumes/Data2/orelse/lemaux/deimos/sc1604/cluster_catalog/EWcats/newEWcats/NIRSPEC/spectroscopic.doubleautocompile.final.idsort.cleaned.lemaux.cat', format='A,A,A', specID, specmask, specslit
	...
	readcol, '/Volumes/Data2/orelse/lemaux/deimos/sc1604/cluster_catalog/EWcats/newEWcats/NIRSPEC/starcats/setup' + setup + '/' + mask[i] + '.' + slit[i] + '.staroutput.cat', format = 'A,A,D,D,D,D,D', refslitindv, LFCIDindv, dgsindv, PAgsindv, rbandgsindv, ibandgsindv, zbandgsindv
	...
	readcol, '/Volumes/Data2/orelse/lemaux/deimos/sc1604/cluster_catalog/EWcats/newEWcats/NIRSPEC/starcats/setup'+ setup + '/goodguidestars.cat', format='A', gsID 	;get LFC IDs of good guide stars from list
	readcol, '/Volumes/Data2/orelse/lemaux/deimos/sc1604/cluster_catalog/EWcats/newEWcats/NIRSPEC/final.idradecmag.lfcpluscosmic.withsdss.cat', format= 'A,D,D', LFCcatID, LFCRA, LFCdec 	;get RA/Dec of all LFC+COS objects from final LFC cat
	...
	file = '/Volumes/Data2/orelse/lemaux/deimos/sc1604/cluster_catalog/EWcats/newEWcats/NIRSPEC/starcats/setup' + setup + '/cutout.setup' + setup + '.fits' ;read in the finder chart
	...
	openw, lun, '/Volumes/Data2/orelse/lemaux/deimos/sc1604/cluster_catalog/EWcats/newEWcats/NIRSPEC/starcats/setup' + setup + '/description.setup' + setup + '.cat', /get_lun
	...
	for i=0, 3-1 do begin			
	printf, lun, 'GS'+gsnum[i]+'NIR'+ setup, tab, goodgsID[i], tab, rank[i], tab, mask[0]+"."+slit[0], tab,  gsRAsexh[i], ':', gsRAsexm[i], ':', gsRAsexs[i], tab, gsdecsexdeg[i], ':', gsdecsexam[i], ':', gsdecsexas[i], tab, rbandgoodgs[i], tab, dgoodgs[i], tab, PAgoodgs[i], tab, dRAgoodgs[i], tab, ddecgoodgs[i], format='(a15, a1, a15, a1, i1, a1, a12, a1, i2.2, a1, i2.2, a1, d6.3, a1, i2.2, a1, i2.2, a1, d5.2, a1, d7.3, a1, d6.3, a1, d7.3, a1, d7.3, a1, d7.3)' 
	endfor

	if n_elements(PAgoodgs2) gt 1 then for i=0, 3-1 do begin
	printf, lun, 'GS'+gsnum[i]+'NIR'+ setup, tab, goodgsID[i], tab, rank[i], tab, mask[1]+"."+slit[1], tab, gsRAsexh[i], ':', gsRAsexm[i], ':', gsRAsexs[i], tab, gsdecsexdeg[i], ':', gsdecsexam[i], ':', gsdecsexas[i], tab, rbandgoodgs[i], tab, dgoodgs2[i], tab, PAgoodgs2[i], tab, dRAgoodgs2[i], tab, ddecgoodgs2[i], format='(a15, a1, a15, a1, i1, a1, a12, a1, i2.2, a1, i2.2, a1, d6.3, a1, i2.2, a1, i2.2, a1, d5.2, a1, d7.3, a1, d6.3, a1, d7.3, a1, d7.3, a1, d7.3)' 
	endfor	
	if n_elements(PAgoodgs3) gt 1 then for i=0, 3-1 do begin
        printf, lun, 'GS'+gsnum[i]+'NIR'+ setup, tab, goodgsID[i], tab, rank[i], tab, mask[2]+"."+slit[2], tab, gsRAsexh[i], ':', gsRAsexm[i], ':', gsRAsexs[i], tab, gsdecsexdeg[i], ':', gsdecsexam[i], ':', gsdecsexas[i], tab, rbandgoodgs[i], tab, dgoodgs3[i], tab, PAgoodgs3[i], tab, dRAgoodgs3[i], tab, ddecgoodgs3[i], format='(a15, a1, a15, a1, i1, a1, a12, a1, i2.2, a1, i2.2, a1, d6.3, a1, i2.2, a1, i2.2, a1, d5.2, a1, d7.3, a1, d6.3, a1, d7.3, a1, d7.3, a1, d7.3)' 
        endfor
	...
	printf, lun, gsnum[0] + '-' + gsnum[1], tab, 'GS'+gsnum[0]+'NIR'+ setup, tab, 'GS'+gsnum[1]+'NIR' + setup, tab, 3600*goodgsgsd[0], tab, 360/(2*!PI)*goodgsgsPA[0], tab, goodgsgsdRA[0], tab, goodgsgsddec[0], format='(a20, a1, a15, a1, a15, a1, d7.3, a1, d7.3, a1, d7.3, a1, d7.2)'	
	printf, lun, gsnum[0] + '-' + gsnum[2], tab, 'GS'+gsnum[0]+'NIR'+ setup, tab, 'GS'+gsnum[2]+'NIR'+ setup, tab, 3600*goodgsgsd[1], tab, 360/(2*!PI)*goodgsgsPA[1], tab, goodgsgsdRA[1], tab, goodgsgsddec[1], format='(a20, a1, a15, a1, a15, a1, d7.3, a1, d7.3, a1, d7.3, a1, d7.2)'
	printf, lun, gsnum[1] + '-' + gsnum[2], tab, 'GS'+gsnum[1]+'NIR'+ setup, tab, 'GS'+gsnum[2]+'NIR'+ setup, tab, 3600*goodgsgsd[2], tab, 360/(2*!PI)*goodgsgsPA[2], tab, goodgsgsdRA[2], tab, goodgsgsddec[2], format='(a20, a1, a15, a1, a15, a1, d7.3, a1, d7.3, a1, d7.3, a1, d7.2)'
	...
	entry_device = !d.name
	set_plot, 'PS'
	device, /color, bits_per_pixel=24, filename = '/Volumes/Data2/orelse/lemaux/deimos/sc1604/cluster_catalog/EWcats/newEWcats/NIRSPEC/starcats/setup' + setup + '/setup'+ setup+ '.finder.ps', xoffset=0.75, yoffset= 0.75, xsize=6.5, ysize=9, /inches
	...
	windowXSize = !d.x_size		; get the x-window size in device coordinates of the PS window
   	...
   	x0 = (0.5/6.5) * windowXSize	; starting x values are 0.5 in inches transform to device coordinates
   	...
   	tv, finder, x0, y0, XSIZE=xsize, YSIZE=ysize	
	...
	xyouts, (0.15/7.0)*windowXsize, 6500-500*[N-1+8], string(gsnum[0], format='(I1)') + '-' + string(gsnum[1], format='(I1)') + '         GS'+ string(gsnum[0], format='(I1)') +'NIR'+ setup + '        GS'+ string(gsnum[1], format='(I1)') +'NIR' + setup + '      ' +  string(goodgsgsdRA[0], format='(D7.3)') + '   ' +  string(goodgsgsddec[0], format='(D7.3)'), charsize=1, color=0, /device	
	xyouts, (0.15/7.0)*windowXsize, 6500-500*[N-1+9], string(gsnum[0], format='(I1)') + '-' + string(gsnum[2], format='(I1)') + '         GS'+ string(gsnum[0], format='(I1)') +'NIR'+ setup + '        GS'+ string(gsnum[2], format='(I1)') +'NIR' + setup + '      ' +  string(goodgsgsdRA[1], format='(D7.3)') + '   ' +  string(goodgsgsddec[1], format='(D7.3)'), charsize=1, color=0, /device
	xyouts, (0.15/7.0)*windowXsize, 6500-500*[N-1+10], string(gsnum[1], format='(I1)') + '-' + string(gsnum[2], format='(I1)') + '         GS'+ string(gsnum[1], format='(I1)') +'NIR'+ setup + '        GS'+ string(gsnum[2], format='(I1)') +'NIR' + setup + '      ' +  string(goodgsgsdRA[2], format='(D7.3)') + '   ' +  string(goodgsgsddec[2], format='(D7.3)'), charsize=1, color=0, /device
