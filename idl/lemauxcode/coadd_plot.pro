...
function Standardize_Spectra, $
    ...
    d_lambdat = (5500.-3000.)/12000. ; wavelength spacing in Angstroms of coadded spectrum
    lambdat = d_lambdat * dindgen(16000) + 3000. ; wavelength array of coadded spectrum
    rspec = dblarr(n,16000) ; individual blueshifted and rebinned spectra [nspec, 12000]
    rivar = dblarr(n,16000) ; associated inverse variances [nspec, 12000]
...
pro Perform_Coadd
    ...
    numread = 208             ; number of columns to read

    ; read in the specifications for each serendip
    readcol, 'allcoaddable_cluster_DEEP2format_2-14-07.cat',  format='A,I,D,D,A,A', mask, slit, Iband, z, q, file, skipline=2, numline=numread
    ...
    finalspec.spec = spec
    finalspec.ivar = ivar
    mwrfits, finalspec, '208coaddablegalaxiesEVAN.fits'
    device, retain=2
