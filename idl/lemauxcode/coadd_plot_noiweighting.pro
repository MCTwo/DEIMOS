...
pro Perform_Coadd
    ...
    readcol, 'a.dat',  format='A,I,D,D,D,A,A', mask, slit, Rband, Zband, z, q, file, skipline=2, numline=numread
    ...
    finalspec.spec = spec
    finalspec.ivar = ivar
    mwrfits, finalspec, '/Volumes/Data2/orelse/lemaux/deimos/sc1604/cluster_catalog/restframe/a.rest.fits'
    device, retain=2
