...
;	for j=0, numread-1 do begin  
   ...
   for i=0, nspec-1 do begin ;begin loop over input list
    ...
    spec = ('/Volumes/Data2/orelse/lemaux/deimos/N2560/' + list[i].maskname + '/*/spec1d.' + list[i].maskname + '.' + list[i].slitname +'.' + list[i].objectno + '.fits')[0]
...
; now normalize 
   ...
   mwrfits, result, 'N2560.060z0625.coadd.fits'
   device, retain=2
