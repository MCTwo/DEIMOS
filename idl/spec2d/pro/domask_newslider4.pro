...
; This is for slider 4 data only, taken after May of 2009 
; and before August 19th 2009 during the actuator repair.
...
pro domask_newslider4, planfile, slitcat=slitcat, chiplist=chiplist, nlsky=nlsky, skipcalib=skipcalib	;BL added slitcat 5/12
...
; write calibSlit files
  ...
  if n_elements(skipcalib) gt 0 then begin
	...
	if filecount lt 20 then begin								
  	deimos_mask_calibrate_newslider4, planfile, /noplot, chiplist=chiplist, slitlist=slitlist
	endif else begin
