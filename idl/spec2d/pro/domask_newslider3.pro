...
; This is for slider 3 data only, taken after May of 2009.
...
pro domask_newslider3, planfile, slitcat=slitcat, chiplist=chiplist, nlsky=nlsky, skipcalib=skipcalib	;BL added slitcat 5/12
...
; write calibSlit files
  ...
  if n_elements(skipcalib) gt 0 then begin
	...
	if filecount lt 20 then begin								
  	deimos_mask_calibrate_newslider3, planfile, /noplot, chiplist=chiplist, slitlist=slitlist
	endif else begin
