...
;      spectrum. 
;      *USE WHEN THE CENTRAL WAVELENGTH OF THE SETUP IS 7300 A OR LESS* 
;
; SYNTAX
...
function fill_gap_blue, file1d, nbuf=nbuf, npoly=npoly, nbins=nbins, $
...
; remove the a-band atmospheric absorption.
  if telluric then begin
      ...
      fix_response_blue,ss1
      if extnum gt 1 then begin 
          remove_telluric, ss2, airmass,silent=silent
	  fix_response_blue,ss2
      endif
  endif
