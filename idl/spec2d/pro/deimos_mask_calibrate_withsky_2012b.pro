...
pro deimos_mask_calibrate_withsky_2012b,  planfile,  chiplist=chiplist, noplot=noplot, $
...
; process optical model for this chip
     ...
     model_lambda.lambda_y[0] = model_lambda.lambda_y[0] + 25.    ; changed WAD 2013/Nov/12, changed to +25 to match Brian's oldslider4 corrections
     model_lambda.lambda_y_top[0] = model_lambda.lambda_y_top[0] + 25. ; changed WAD 2013/Nov/12, changed to +25 to match Brian's oldslider4 corrections
     model_lambda.lambda_y_bottom[0] = model_lambda.lambda_y_bottom[0] + 50. ; changed WAD 2013/Nov/12, changed to +50 to match Brian's oldslider4 corrections
...
;retrieve true slitn, for use in output name and for possible selection
       ...
       print, 'Bluslitno is', bluslitno            ;added WD 25oct2013
