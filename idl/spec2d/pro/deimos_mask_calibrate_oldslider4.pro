...
pro deimos_mask_calibrate_oldslider4,  planfile,  chiplist=chiplist, noplot=noplot, $
...
; process optical model for this chip
     ...
     model_lambda.lambda_y[0] = model_lambda.lambda_y[0] + 25.		;changed BL 5/5/09, these three lines suggested by Jeff Newman to fix the slider four optical model problem
     model_lambda.lambda_y_top[0] = model_lambda.lambda_y_top[0] + 25.
