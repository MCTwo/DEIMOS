;+
; NAME:
;   deimos_mask_calibrate_oldslider3
;
; PURPOSE:
;   top level routine to generate flats and arcs to a given mask,
;   with separate FITS files for each slitlet. For slider 3 data
;   taken prior to May of 2009. The optical model is identical 
;   to the original deimos_mask_calibrate optical model.
;
; CALLING SEQUENCE:
;   deimos_mask_calibrate_oldslider3, planfile, chiplist=chiplist, $
...
pro deimos_mask_calibrate_oldslider3,  planfile,  chiplist=chiplist, noplot=noplot, $
