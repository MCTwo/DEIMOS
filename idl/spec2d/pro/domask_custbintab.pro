...
pro domask_custbintab, planfile, slitcat=slitcat, chiplist=chiplist, nlsky=nlsky, skipcalib=skipcalib	;BL added slitcat 5/12
...
;  make_bintab_file, planfile ;WD commented out this line on 2013-Oct-24, since trying method where I edit an existing bintab file to remove ghost slits
  print,'Note: Using existing bintab file.'

  deimos_isdeep,isdeep,file='ciza1A.bintabs.fits'
