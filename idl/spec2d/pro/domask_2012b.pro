...
pro domask_2012b, planfile, slitcat=slitcat, chiplist=chiplist, nlsky=nlsky ;WD added slitcat 10/2013
...
; write calibSlit files
  ...
  deimos_mask_calibrate_withsky_2012b, planfile, /noplot, chiplist=chiplist, slitlist=slitlist ;12 Nov 2013 WD, called a modified version of the calibrate code that includes adjustments to the initial wavelength solution guess, also added slitlist
