...
;
; PURPOSE:
;       Calculate across-correlation function
;       Locate the precise location of the peak.
;       (Locates LAG_max)
;
; CALLING SEQUENCE:
;
;       LAG_max = CCPEAK(FUNC1, FUNC2 [, RADIUS ])
;
; INPUTS:
;
;       FUNC1, FUNC2 - Functions to be cross-correlated
...
function ccpeak,arr1, arr2, radius, ccf=cf
